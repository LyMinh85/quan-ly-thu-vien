...
public class SachDAO {
    ...
    public boolean update (SachDTO sach)
    {
        try{
            Connection con = MyConnection.getConnection();
            String queryUpdate = "UPDATE SACH SET tenSach=?, giaSach=?, soluong=?, trangthai=?, idTacGia=?, idNhaXuatBan=?, idLoaiSach=?, idKho=? where id=?";
            ...
            ps.setInt(8, sach.getIdKho());
            ps.setInt(9, sach.getId());
